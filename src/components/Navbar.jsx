...
export default function Navbar() {
  ...
  const navElStyle =
    "navLink flex flex-none flex-row flex-wrap-nowrap justify-start items-center sm:gap-5 hover:text-white cursor-pointer relative";
  ...
  return (
    <div className="navContainer p-4 bg-black flex sm:min-w-[200px] sm:h-[100%] sm:flex-col justify-between">
      <div className="navTop grid gap-2 sm:flex-col sm:gap-4  w-full">
        <NavLink className="logo my-4" to="/">
          <img src={logo2} alt="Logo von Toffeespy" />
          ...
          <p className="float-right">A Spotify hommage for test runs only </p>
        </NavLink>
      ...
      <div className="navBottom text-sm flex flex-col gap-1 invisible sm:visible">
        <span>Legal</span>
        ...
        <span>About Ads</span>
        <span>Cookies</span>
        <button className="rounded-full text-base border border-slate-200">
          Language
        </button>
      </div>
    </div>
